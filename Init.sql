...
CREATE TABLE waybill (
    wayID INT NOT NULL PRIMARY KEY,
...
(1, '张三', '13800000001', '北京市海淀区', 'M', '寄件'),
(2, '李四', '13800000002', '上海市浦东新区', 'F', '收件'),
(3, '王五', '13800000003', '广州市天河区', 'M', '收件');

-- 2. 订单表
INSERT INTO orders VALUES
(1001, 1, 2, '2026-01-06 09:00:00', '正常', 25.50),
(1002, 1, 3, '2026-01-06 10:00:00', '异常', 40.00);

-- 3. 包裹表
INSERT INTO package VALUES
(2001, 1001, 1.5, 0.01, '正常', '在运输中'),
(2002, 1002, 2.0, 0.02, '易碎物', '已入库');

-- 4. 快递公司表
INSERT INTO company VALUES
(3001, '顺丰', 'SF', '400-811-1111'),
(3002, '中通', 'ZT', '400-821-2222');

-- 5. 运单表
INSERT INTO waybill VALUES
(4001, 2001, 3001, '北京市', '上海市', '2026-01-06 09:30:00', '运输中'),
(4002, 2002, 3002, '北京市', '广州市', '2026-01-06 10:30:00', '已揽收');

-- 6. 快递员表
INSERT INTO deliveryman VALUES
(5001, 3001, '小李', '13800138001', 'M', '同城运送'),
(5002, 3002, '小王', '13800138002', 'F', '干线转运');

-- 7. 轨迹表
INSERT INTO track VALUES
(6001, 4001, 5001, '2026-01-06 10:00:00', '北京市海淀区', '已揽收，出发'),
(6002, 4002, 5002, '2026-01-06 11:00:00', '北京市丰台区', '已揽收，等待转运');

-- 8. 驿站表
INSERT INTO station VALUES
(7001, '海淀驿站', '北京市海淀区', 'HD001', '010-88888888'),
(7002, '浦东驿站', '上海市浦东新区', 'PD001', '021-88888888');

-- 9. 工作人员表
INSERT INTO staff VALUES
(8001, 7001, '张助理', 'M', '13800111111', '管理员'),
(8002, 7002, '李仓库', 'F', '13800222222', '整理仓库者');

-- 10. 异常信息表
INSERT INTO exception VALUES
(9001, 2002, '易碎物破损', '破碎', '包裹在运输中破损');

-- 11. 入库信息表
INSERT INTO storage VALUES
(2002, 7002, '2026-01-06 10:45:00', 'ST001', '正常');

-- 12. 签收记录表
INSERT INTO sign VALUES
(10001, 2001, 7001, 2, '送货上门', '2026-01-06 12:00:00'),
(10002, 2002, 7002, 3, '驿站自取', '2026-01-06 13:00:00');
